 ...
 * 0 if s1 == s2, Negative byte differnce if s1 < s2
 */
...
/**
 * insertion_sort_deck_kind - sort deck of cards from spades to diaonds
 ...
 * @deck: pointer to the head of a deck_node_t doubly-lined list
 */
...
/**
 * sort_deck - sort deck of cards from ace to king
